...
def mostrar_analisis_descriptivo(df):
    ...
    # ============================================================
    # SECCION: ANALISIS DE RENDIMIENTO ACADEMICO
    # ============================================================
    columnas_necesarias = ['Nota_parcial', 'RESULTADO FINAL']
    ...
    # ============================================================
    # SECCIÓN: TABLA DINÁMICA (DOCENTE-ASIGNATURA-NRC)
    # ============================================================
    ...
    **Configuración:**
            ...
            with st.spinner("Generando tabla dinámica..."):
                try:
                    ...
                    if len(df_filtrado) == 0:
                        ...
                        # DIAGRAMAS DE BARRAS POR NIVEL JERÁRQUICO
                        ...
                        with tabs_barras[0]:
                            ...
                            df_docente['Porcentaje'] = (df_docente[var_valor] / total_general_doc * 100).round(1) if total_general_doc > 0 else 0
                        ...
                        with tabs_barras[1]:
                            ...
                            df_asignatura['Porcentaje'] = (df_asignatura[var_valor] / total_general_asig * 100).round(1) if total_general_asig > 0 else 0
                        ...
                        with tabs_barras[2]:
                            if var_fila3:
                                ...
                                df_nrc['Porcentaje'] = (df_nrc[var_valor] / total_general_nrc * 100).round(1) if total_general_nrc > 0 else 0
                        ...
                        with tabs_barras[3]:
                            ...
                            df_modalidad['Porcentaje'] = (df_modalidad[var_valor] / total_general_mod * 100).round(1) if total_general_mod > 0 else 0
                            ...
                            for i, mod in enumerate(modalidades_esperadas):
                                ...
                                porcentaje = df_modalidad[df_modalidad[var_columna] == mod]['Porcentaje'].values[0] if len(df_modalidad[df_modalidad[var_columna] == mod]) > 0 else 0
    ...
    # ============================================================
    # ANALISIS UNIVARIADO (CATEGORICO) CON DIAGRAMA DE BARRAS PORCENTUAL
    # ============================================================
    if columnas_categoricas:
        ...
        if len(datos_cat) > 0:
            ...
            # 3 columnas para 3 gráficos: Barras, Circular y Barras Porcentual
